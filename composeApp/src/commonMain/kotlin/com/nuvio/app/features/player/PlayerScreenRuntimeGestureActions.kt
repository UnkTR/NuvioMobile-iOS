...
internal data class PlayerSurfaceGestureCallbacks(
    ...
    val beginHorizontalSeek: State<() -> Unit>,
    val liveHorizontalSeek: State<(Long) -> Unit>,
...
internal fun PlayerScreenRuntime.showHorizontalSeekPreview(previewPositionMs: Long, baselinePositionMs: Long) {
    horizontalSeekPreview = HorizontalSeekPreviewState(
...
internal fun PlayerScreenRuntime.beginHorizontalSeek() {
    playerController?.setMuted(true)
}

internal fun PlayerScreenRuntime.liveHorizontalSeek(targetPositionMs: Long) {
...
internal fun PlayerScreenRuntime.rememberSurfaceGestureCallbacks(): PlayerSurfaceGestureCallbacks {
    ...
    return PlayerSurfaceGestureCallbacks(
        ...
        beginHorizontalSeek = rememberUpdatedState(::beginHorizontalSeek),
        liveHorizontalSeek = rememberUpdatedState(::liveHorizontalSeek),
